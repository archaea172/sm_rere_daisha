...
// ORTHOGONALS
using sm_rere_daisha::OrTimer;  // This is an example variable - feel free to delete it.
...
using sm_rere_daisha::OrTimer;

// STATE DECLARATION
struct State1 : smacc2::SmaccState<State1, SmRereDaisha>
{
